...
- **komponen aktif** di `components/` — rk/{RKShell, Panel, Kompas, Drawer, Palet}, ui/{Ikon, StatusIkon}, CatatanTujuan, asesor/{CatatanMandiri}, OPDTable, motif/KerawangMotifs
