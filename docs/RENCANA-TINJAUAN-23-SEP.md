...
- **3a** `pemdi` → per aspek: **7 kartu "dial"** (busur skor mandiri vs asesor) yang membuka akordeon indikator; `requirement` → **papan tugas 3 kolom** (Belum/Proses/Diterima) + tab PPB sekunder; `cari` → dilebur ke Palet (Ctrl+K) + halaman hasil bergaya daftar RK.
